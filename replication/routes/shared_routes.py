...
@shared_router.post("/get_db_list")
...
@shared_router.post("/get_current_db")
...
@shared_router.post("/set_current_db")
...
@shared_router.post("/set_wal_level")
...
@shared_router.post("/set_max_wal_senders")
...
@shared_router.get("/get_hba_file")
...
@shared_router.post("/replace_hba_file")
...
@shared_router.post("/add_replication_user")
...
@shared_router.post("/set_replica_server")
...
@shared_router.get("/get_data_directory")
...
# @shared_router.post("/run_basebackup")
...
@shared_router.post("/start_replica_server")
...
@shared_router.post("/stop_replica_server")
